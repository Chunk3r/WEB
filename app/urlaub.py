...
#----------------------------------------------------------
class Urlaub_cl(object):
#----------------------------------------------------------

   #-------------------------------------------------------
   def __init__(self, db_opl, view_opl):
   #-------------------------------------------------------
      self.db_o = db_opl.getStorage_px('urlaub')
      self.defaults_o = db_opl.getDefaults_px('urlaub')
   ...
   @cherrypy.expose
   #-------------------------------------------------------
   def save(self, id_spl, startDatum_spl, endDatum_spl, dauer_ipl, mID_o):
   #-------------------------------------------------------
      id_s = id_spl
      data_o = {
         "startDatum": startDatum_spl,
         "endDatum": endDatum_spl,
         "dauer": int(dauer_ipl),
         "mID": mID_o
      }
      if id_s != "None":
